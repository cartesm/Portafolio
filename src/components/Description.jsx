...
function Description() {
  return (
    <div className="grid grid-cols-2 py-16">
        <div className="flex items-center flex-col gap-5 pt-8">
            <h3 className="font-sans text-4xl"><b>Acerca de mi</b></h3>
            <p className="w-[500px] font-sans text-lg indent-7 leading-8">
        ...
        <div>   
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam consequatur adipisci neque tempore aspernatur nostrum eos vero voluptatem, unde tempora praesentium quod rem explicabo, quia nisi modi perspiciatis aperiam odio?
        </div>
    </div>
  )
}
