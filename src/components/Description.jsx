  ...
  return (
    ...
    <div id="me" className="flex flex-col md:flex-row pb-[100px] items-center justify-center gap-12">
        <div className="flex items-center flex-col gap-5">
            ...
            <p className=" xd min-w-[390px] max-w-[600px] px-6 font-sans text-lg text-center leading-8">
        ...
        <div className="">   
          <svg className="min-w-[290px] rotate-180 px-2 max-w-[500px]" xmlns="http://www.w3.org/2000/svg" viewBox="-11.5 -10.23174 23 20.46348">
